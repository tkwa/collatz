...
rungs, explanatory literature conjectures, historical examples, and open
supporting targets in `progress/` or `blockers/`. Those files were inspected
for scope and naming conflicts but are not claimed as covered here.
